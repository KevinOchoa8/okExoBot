...
public class okPersonaTipoDTO {
    ...
    public okPersonaTipoDTO(){}
    public okPersonaTipoDTO(Integer idCatalogo, Integer idCatalogoTipo, String nombre, String descripcion,
