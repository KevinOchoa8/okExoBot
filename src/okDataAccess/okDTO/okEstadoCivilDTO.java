package okDataAccess.okDTO;

public class okEstadoCivilDTO {
    ...
    public okEstadoCivilDTO(){}
    public okEstadoCivilDTO(Integer idCatalogo, Integer idCatalogoTipo, String nombre, String descripcion, String estado,
