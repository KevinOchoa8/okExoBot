...
public class okTextBox extends JTextField {
    ...
    private void customizeComponent() {
        setBorderRect();
        setBorderDownLine();
        setFont(okAppStyle.FONT);  
        setForeground(okAppStyle.COLOR_FONT_LIGHT);  
        setCaretColor(okAppStyle.COLOR_CURSOR);   // Color del cursor
    ...
    public void setBorderRect() {
        Border lineBorder = BorderFactory.createLineBorder(okAppStyle.COLOR_BORDER);
    ...
    private void setBorderDownLine(){
        ...
        setBorder(  BorderFactory.createCompoundBorder(
                    ...
                    BorderFactory.createMatteBorder(0, 0, thickness, 0, okAppStyle.COLOR_BORDER) 
        ));
    }
}
