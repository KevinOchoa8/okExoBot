...
public class okButton extends JButton implements MouseListener {
    ...
    public okButton(String text, String iconPath){
    ...
    public void customizeComponent(String text) {
        ...
        setHorizontalAlignment(okAppStyle.ALIGNMENT_LEFT);
        setFont(okAppStyle.FONT);
    ...
    public void mouseEntered(MouseEvent e) {
        ...
        setCursor(okAppStyle.CURSOR_HAND);
    }

    @Override
    public void mouseExited(MouseEvent e) {
        setForeground(Color.GRAY);
        setCursor(okAppStyle.CURSOR_DEFAULT);
    }
}
