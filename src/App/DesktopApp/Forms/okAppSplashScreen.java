...
public class okAppSplashScreen extends JFrame {
    private static final double SCALE_PERCENT = 0.6; // % del tamaño original de la imagen

    public okAppSplashScreen() {
        initComponents();
    }

    private void initComponents() {
        JProgressBar prbLoading = new JProgressBar(0, 100);
        ImageIcon icoImagen = new ImageIcon(okAppConfig.getImgSplash());
