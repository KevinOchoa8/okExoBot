...
CREATE TABLE Ensamblado (
   ...
   ,IdExoBot                   INTEGER      NOT NULL REFERENCES ExaBot(IdExaBot)
   ,IdPersonaSoldado           INTEGER      NOT NULL REFERENCES Persona(IdPersona)
   ,IdPersonaMecatronico       INTEGER      NOT NULL REFERENCES Persona(IdPersona)
